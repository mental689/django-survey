# Generated by Django 2.1.2 on 2018-10-11 06:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vid', models.CharField(blank=True, max_length=50, verbose_name='Video ID')),
                ('type', models.IntegerField()),
                ('start', models.IntegerField(verbose_name='Start time')),
                ('end', models.IntegerField(verbose_name='End time')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Update date')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='response',
            name='video',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='survey.Video', verbose_name='Video'),
        ),
        migrations.AddField(
            model_name='question',
            name='survey',
